    ...
    <>
     <section className='py-20'>
        <div className="container-fluid">
            ...
            <div className="flex justify-between items-center w-full rounded-lg p-20 border border-[#262626]" style={{ background:`url(${bg}) no-repeat center`,backgroundSize:'cover', }}>
                <div className="">
                ...
                <a className='bg-[#E50000] py-2 px-4 font-manrope font-normal text-lg rounded-lg' href="#"> Start a Free Trial </a>
            </div>
            </div>
        </div>
     </section>
